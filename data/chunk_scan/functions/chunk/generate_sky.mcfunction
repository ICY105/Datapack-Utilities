...
execute at @s positioned ~16 255 ~ unless block ~ ~ ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
execute at @s positioned ~-16 255 ~ unless block ~ ~ ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
execute at @s positioned ~ 255 ~16 unless block ~ ~ ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
execute at @s positioned ~ 255 ~-16 unless block ~ ~ ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
