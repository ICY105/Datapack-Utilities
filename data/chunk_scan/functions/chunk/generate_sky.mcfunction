...
execute at @s positioned ~16 0 ~ unless block ~ 255 ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ 0 ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
execute at @s positioned ~-16 0 ~ unless block ~ 255 ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ 0 ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
execute at @s positioned ~ 0 ~16 unless block ~ 255 ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ 0 ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
execute at @s positioned ~ 0 ~-16 unless block ~ 255 ~ #chunk_scan:sky_marker run summon minecraft:area_effect_cloud ~ 0 ~ {Tags:[chunk_scan.chunk],Duration:2147483647}
