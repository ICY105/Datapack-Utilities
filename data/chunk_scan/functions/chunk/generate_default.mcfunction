...
execute at @s positioned ~16 0 ~ unless block ~ ~ ~ #chunk_scan:default_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["chunk_scan.chunk"],Duration:2147483647}
execute at @s positioned ~-16 0 ~ unless block ~ ~ ~ #chunk_scan:default_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["chunk_scan.chunk"],Duration:2147483647}
execute at @s positioned ~ 0 ~16 unless block ~ ~ ~ #chunk_scan:default_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["chunk_scan.chunk"],Duration:2147483647}
execute at @s positioned ~ 0 ~-16 unless block ~ ~ ~ #chunk_scan:default_marker run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["chunk_scan.chunk"],Duration:2147483647}
