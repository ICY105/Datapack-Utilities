...
#Notification
execute unless score temp_0 du_data matches 1 run tellraw @a {"text":"Datapack setup complete!","color":"dark_green"}
...
execute unless block -29999999 0 1601 shulker_box run setblock -29999999 0 1601 minecraft:shulker_box
