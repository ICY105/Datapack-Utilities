...
#set timers
scoreboard players set timer_2 du_data 0
scoreboard players set timer_10 du_data 0
scoreboard players set timer_20 du_data 0
scoreboard players set timer_100 du_data 0
