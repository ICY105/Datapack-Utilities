...
execute if score temp_0 du_data matches 0 run tellraw @a {"text":"[DU] Click here to complete datapack setup.","color":"dark_green","clickEvent":{"action":"run_command","value":"/forceload add -30000000 1600"}}
