...
execute store result score temp_1 du_data unless block ~ ~ ~ furnace{Items:[{Slot:1b}]} run data get block ~ ~ ~ Items[{Slot:1b}].Count
execute store result score temp_1 du_data if block ~ ~ ~ furnace{Items:[{Slot:1b}]} run data get block ~ ~ ~ Items[{Slot:2b}].Count
