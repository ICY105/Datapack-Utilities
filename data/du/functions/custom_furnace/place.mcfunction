...
execute if block ~ ~ ~ minecraft:campfire align xyz positioned ~0.5 ~0.5 ~0.5 unless entity @e[tag=du_campfire,distance=..0.5] run summon item_frame ~ ~ ~ {Tags:["du_campfire"],Fixed:1b,Invisible:1b}
