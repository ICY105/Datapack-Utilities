...
execute store result score temp_0 du_data run data get block ~ ~ ~ Items[{Slot:2b}].Count
...
execute store result score temp_1 du_data run data get block ~ ~ ~ Items[{Slot:2b}].Count

scoreboard players operation temp_0 du_data += temp_1 du_data
execute store result block ~ ~ ~ Items[{Slot:2b}].Count byte 1 run scoreboard players get temp_0 du_data

execute store result score temp_0 du_data run data get block ~ ~ ~ Items[{Slot:0b}].Count
scoreboard players remove temp_0 du_data 1
execute store result block ~ ~ ~ Items[{Slot:0b}].Count byte 1 run scoreboard players get temp_0 du_data
