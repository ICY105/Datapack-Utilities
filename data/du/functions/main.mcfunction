...
execute if score worldgen du_data matches 1 if score timer_20 du_data matches 0 as @a[gamemode=!spectator] at @s run function du:world/generation/worldgen
