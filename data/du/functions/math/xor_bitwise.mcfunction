...
scoreboard players set $math.temp_3 du_data 2
...
scoreboard players operation $math.temp_0 du_data *= $math.temp_3 du_data
scoreboard players operation $math.temp_1 du_data *= $math.temp_3 du_data
