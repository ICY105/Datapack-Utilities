...
#modify item
data modify storage du:temp object set from entity @s Inventory[{Slot:102b}]
...
item entity @s armor.chest modify du:append_durability_lore
execute if score $player.out_0 du_data matches -1..0 run playsound minecraft:entity.item.break player @a[distance=..16]
execute if score $player.out_0 du_data matches 0 run item entity @s armor.chest replace minecraft:air
