...
execute unless score $player.in_1 du_data matches 1 run scoreboard players operation $player.in_0 du_data *= temp_0 du_data
execute unless score $player.in_1 du_data matches 1 run scoreboard players operation $player.in_0 du_data /= temp_1 du_data
