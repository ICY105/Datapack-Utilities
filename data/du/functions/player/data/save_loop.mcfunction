...
#cycle data
#tellraw @p [{"nbt":"RecordItem.tag.du.player_data","block":"-29999999 0 1600","color":"green"}]
...
#tellraw @p [{"nbt":"RecordItem.tag.du.player_data","block":"-29999999 0 1600","color":"dark_green"}]
