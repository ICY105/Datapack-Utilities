...
execute if entity @s[tag=!du_has_recipe] if score $base.timer_20 du_data matches 0 if score $crafting.temp_0 du_data matches 0 unless block ~ ~ ~ #du:internal/chest-like{Items:[{Slot:16b}]} run function du:custom_crafter/check_recipes
