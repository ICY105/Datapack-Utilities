...
#LCG
scoreboard players operation $word.rng_seed du_data *= $cons.rng_a du_data
scoreboard players add $word.rng_seed du_data 12345

#output
scoreboard players operation $math.out_0 du_data = $word.rng_seed du_data
