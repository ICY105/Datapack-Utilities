...
#load data
execute store result score temp_1 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_nether[0].size
execute store result score temp_2 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_nether[0].ignore_placement
execute store result score temp_3 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_nether[0].weight
execute store result score temp_4 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_nether[0].isBlacklist
...
execute if score temp_5 du_data matches 1 if score temp_4 du_data matches 0..1 run function du:world/generation/struct_gen/check_biomes_nether
...
execute if score temp_5 du_data matches 1 run data modify block -29999999 0 1600 RecordItem.tag.du.temp_struct_list append from block -29999999 0 1600 RecordItem.tag.du.struct_reg_nether[0]
