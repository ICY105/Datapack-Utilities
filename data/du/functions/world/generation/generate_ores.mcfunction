...
#run proper function
execute if score in_2 du_data matches -1 run function du:world/generation/generate_ores_nether
execute if score in_2 du_data matches 0 run function du:world/generation/generate_ores_overworld
execute if score in_2 du_data matches 1 run function du:world/generation/generate_ores_end
