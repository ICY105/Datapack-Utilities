...
execute if score in_10 du_data matches 0..1 run function du:world/generation/biome_list/check_ore_list_overworld
execute if score in_10 du_data matches 0 if score out_0 du_data matches 1 run function du:world/generation/displace_ore/start
execute if score in_10 du_data matches 1 if score out_0 du_data matches 0 run function du:world/generation/displace_ore/start
execute if score in_10 du_data matches -1 run function du:world/generation/displace_ore/start
...
execute unless score temp_0 du_data = in_3 du_data run function du:world/generation/generate_ores_overworld
