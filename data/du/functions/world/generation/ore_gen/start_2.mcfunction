...
scoreboard players operation temp_1 du_data = in_7 du_data
...
scoreboard players set in_0 du_data 14
function du:math/random
scoreboard players operation temp_3 du_data = out_0 du_data

#vein size
scoreboard players operation in_0 du_data = in_12 du_data
scoreboard players operation in_0 du_data -= in_11 du_data
function du:math/random
scoreboard players operation temp_4 du_data = in_11 du_data
scoreboard players operation temp_4 du_data += out_0 du_data

### transfer scores
#id
execute store result score in_0 du_data run data get block -29999999 0 1600 RecordItem.tag.du.temp[0].id

function du:world/generation/ore_gen/displace_x

scoreboard players remove in_9 du_data 1
