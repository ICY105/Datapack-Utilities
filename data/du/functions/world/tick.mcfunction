...
execute if score worldgen du_data matches 1 if score is_loaded du_data matches 1.. if score timer_20 du_data matches 1 as @a[gamemode=spectator] at @s unless entity @p[distance=1..] run function du:world/generation/start
