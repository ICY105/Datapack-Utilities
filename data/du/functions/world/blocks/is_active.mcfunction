...
execute if score $world.out_1 du_data matches 0 positioned ~ ~-1 ~ if block ~ ~ ~ #du:internal/redstone/weak_power_bottom if predicate du:block/is_emitting_signal run scoreboard players set $world.out_1 du_data 1
execute if score $world.out_1 du_data matches 0 positioned ~01 ~ ~ if block ~ ~ ~ #du:internal/redstone/weak_power_side if predicate du:block/is_emitting_signal run scoreboard players set $world.out_1 du_data 1
execute if score $world.out_1 du_data matches 0 positioned ~-1 ~ ~ if block ~ ~ ~ #du:internal/redstone/weak_power_side if predicate du:block/is_emitting_signal run scoreboard players set $world.out_1 du_data 1
execute if score $world.out_1 du_data matches 0 positioned ~ ~ ~01 if block ~ ~ ~ #du:internal/redstone/weak_power_side if predicate du:block/is_emitting_signal run scoreboard players set $world.out_1 du_data 1
execute if score $world.out_1 du_data matches 0 positioned ~ ~ ~-1 if block ~ ~ ~ #du:internal/redstone/weak_power_side if predicate du:block/is_emitting_signal run scoreboard players set $world.out_1 du_data 1
